// ─────────────────────────────────────────
//  src/ai/answerGenerator.js
//  Sends retrieved chunks + question to Groq
//  Returns a precise, structured answer
// ─────────────────────────────────────────
...
const TEMPERATURE = 0.1; // factual answers only

// ── System prompt for college student bot ──
...
2. Never reveal one department's data to another department's faculty
...
7. For student searches show: Roll No, Name, Dept, Year, Attendance%, CGPA, Status
...
/**
 * Generate answer from retrieved chunks + user question
 *
 * @param {string} query        - User's question
 * @param {Array}  chunks       - Top K retrieved chunks
 * @param {Object} userContext  - { role, department, name }
...
/**
 * Generate a structured department report
 */
...
5. AT-RISK STUDENTS — attendance < 75% OR CGPA < 5.0
6. RECOMMENDATIONS
...
/**
 * Detect what the user wants (intent detection)
 */
